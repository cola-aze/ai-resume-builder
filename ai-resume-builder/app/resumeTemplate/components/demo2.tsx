...
import Demo2 from "./demo2Temp";
import { ResumeData } from "./types";

// Sample data for the resume
const sampleResumeData: Partial<ResumeData> = {
    name: "张三",
    jobTitle: "前端开发工程师",
    phone: "13800138000",
    email: "zhangsan@example.com",
    workExperience: [
        "2022-2025 某科技公司 高级前端开发",
        "2020-2022 某互联网公司 前端开发",
        "2018-2020 某科技有限公司 初级开发",
    ],
    skills: [
